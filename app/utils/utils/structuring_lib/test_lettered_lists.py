...
should be detected as a list item and tagged LL-MID, not generic body text.
...
def test_detect_list_kind_recognizes_mnemonic_lettered_pattern():
    assert detect_list_kind("A   Apple is for resilience") == ("lettered", "upper")


def test_lettered_list_items_tagged_ll_mid():
    doc = Document()
...
def test_detect_list_kind_recognizes_em_dash_mnemonic_pattern():
    assert detect_list_kind("S—Is your sleep disturbed?") == ("lettered", "upper")


def test_detect_list_kind_recognizes_en_dash_mnemonic_pattern():
    assert detect_list_kind("I–Have you noted a loss of libido?") == ("lettered", "upper")


def test_detect_list_kind_recognizes_em_dash_with_trailing_space():
    assert detect_list_kind("A— Have you experienced changes in your appetite?") == ("lettered", "upper")
