        ...
        <div className="space-y-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border-2 border-transparent hover:border-blue-300 transition-colors"
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-blue-600 font-medium mt-2">
                📄 Output: Annotated .docx with highlighted changes
              </div>
            </div>
          </label>
          ...
          <label className="flex items-start gap-3 cursor-pointer p-3 rounded-lg border-2 border-transparent hover:border-blue-300 transition-colors"
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-blue-600 font-medium mt-2">
                💬 Output: .docx with Word comments for issues
              </div>
            </div>
          </label>
          ...
          <div className="pt-2 border-t border-blue-200">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                ...
                <div className="text-xs text-text">Only produce the log/report — do not save an annotated Word document.</div>
              </div>
            </label>
          </div>
        </div>
