...
def upgrade() -> None:
    ...
    # Create clients table only if it doesn't already exist
    ...
    # Add client_id to projects only if it doesn't already exist
    ...
    if 'fk_projects_client_id' not in existing_fks:
